...
class SodiumTests: XCTestCase {
    ...
    func testScalarMult() {
        ...
        let alicePublicKey = sodium.scalarMult.base(secretKey: aliceSecretKey)

        XCTAssertTrue(alicePublicKey == [
        ...
        let sharedKey = sodium.scalarMult.mult(publicKey: bobPublicKey, secretKey: aliceSecretKey)

        XCTAssertTrue(sharedKey == [
